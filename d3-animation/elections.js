// https://observablehq.com/@karimdouieb/try-to-impeach-this-challenge-accepted@1359
export default function define(runtime, observer) {
  const main = runtime.module();
  main.variable(observer()).define(["md"], function(md){return(
md`# US Elections 2016-2020`
)});
  main.variable(observer()).define(["tweet"], function(tweet){return(
tweet("1178030815671980032")
)});
  main.variable(observer("vote_map")).define("vote_map", ["width","d3","DOM","projection","counties","format","topojson","us"], function(width,d3,DOM,projection,counties,format,topojson,us)
{
  ...
  main.variable(observer("vote_map_population_bubble")).define("vote_map_population_bubble", ["width","d3","DOM","projection","counties"], function(width,d3,DOM,projection,counties)
{
  const height = width * 5/8;
  ...
  main.variable(observer("vote_map_animation")).define("vote_map_animation", ["width","d3","DOM","projection","counties","format","flubber"], function(width,d3,DOM,projection,counties,format,flubber)
{
  ...
  main.variable(observer()).define("maxRadius", function(){return(
25
)});
